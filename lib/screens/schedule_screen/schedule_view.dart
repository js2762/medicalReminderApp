                        ...
                        return InkWell(
                          ...
                          child: Obx(
                            () {
                              ...
                              String day =
                                  DateFormat('EEE').format(currentDate2);
                              String date =
                                  DateFormat('dd').format(currentDate2);
                              return Container(
                                width: 60,
                                ...
                                decoration: BoxDecoration(
                                  color:
                                      scheduleController.selectedIndex.value ==
                                              index
                                          ? AppColors.appOrange
                                          : AppColors.lightGrey,
                            ...
                            Expanded(
                              child: Container(
                                ...
                                child: showText(index,
                                    scheduleController.addedMedicineDataList),
                              ),
                            ),
                          ],
                        ),
                    ...
                    child: Obx(
                      () {
                        return Text(
                          ...
                          style:
                              scheduleController.selectedDayWeek.value == index
                                  ? const TextStyle(
                                      color: AppColors.appOrange, fontSize: 18)
                                  : const TextStyle(
