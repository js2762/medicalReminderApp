  ...
  void saveData() async {
    ...
    if (pillName.isEmpty) {
      ...
      try {
        ...
        final addingMedicine =
            AddedMedicine(name: pillName, addedTime: selectedHour.value);
        bool isExisting = addedMedicineData
            .any((model) => model.addedTime == addingMedicine.addedTime);
        if (!isExisting) {
